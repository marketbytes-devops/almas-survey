  ...
  return (
    <div className="flex flex-col">
      ...
      <DatePicker
        ...
        className={`w-full px-3 py-2 text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors ${error ? "border-red-500" : "border-gray-300"}`}
      />
