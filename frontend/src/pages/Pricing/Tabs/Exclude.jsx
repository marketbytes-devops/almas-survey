  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-500">
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 sm:p-8">
        <h3 className="text-lg font-medium text-gray-800 mb-6 border-b border-gray-100 pb-4">Exclusion Configuration</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 items-end">
          <div className="lg:col-span-2">
            <Label required>Exclusion Text</Label>
            <input
              type="text"
              value={newText}
            ...
            <div>
              ...
              >
                {saving ? (
                  ...
                  <>
                    <FaPlus className="w-4 h-4" /> Add Exclusion
                  </>
                )}
              </button>
            </div>
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 sm:px-8 sm:py-6 border-b border-gray-100">
          <h3 className="text-lg font-medium text-gray-800">What is Excluded</h3>
        </div>
        ...
        {items.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 font-medium">No exclusions added yet</p>
            <p className="text-xs text-gray-600 mt-1">Add your first exclusion above</p>
          </div>
        ) : (
          <>
            <div className="hidden md:block overflow-x-auto">
              <table className="w-full text-left">
                <thead className="bg-gray-50/50">
                  <tr>
                    <th className="px-8 py-4 text-xs font-medium text-gray-600 uppercase tracking-widest w-full">Exclusion</th>
