        ...
        <div className="bg-gray-50 min-h-screen">
            <div className="max-w-full mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
                <div className="bg-gradient-to-r from-[#4c7085] to-[#6b8ca3] text-white py-4 px-6">
                    <h1 className="text-xs sm:text-lg font-medium">Material Management</h1>
                </div>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                <div className="grid grid-cols-1 gap-6">
                                    <Input
                                        ...
                                        name="name"
                                        type="text"
                                        placeholder="e.g. Bubble Wrap, Cartons"
                                ...
                                >
                                    {saving ? "Saving..." : "Save New Material"}
                                </button>
                            </form>
                        </FormProvider>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
                        ...
                        {materials.length > 0 ? (
                            ...
                            <div className="text-center py-12 text-gray-600">
                                <p className="text-base sm:text-lg mb-2">No materials found.</p>
                            </div>
                        )}
                    </div>
                </div>
