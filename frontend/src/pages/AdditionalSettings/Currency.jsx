...
const Currency = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      reset();
      setIsAddOpen(false);
      setMessage("Currency saved successfully!");
  ...
  const handleDeleteCurrency = async (id) => {
    ...
    try {
      ...
      setError("Failed to delete currency. It may be in use.");
      setTimeout(() => setError(null), 3000);
    }
  };
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <PageHeader
        ...
        subtitle="Manage supported currencies for quotations and billing"
      />
      ...
      {filteredCurrencies.length === 0 ? (
        <div className="bg-white rounded-3xl p-16 text-center border border-dashed border-gray-200">
          ...
          <h3 className="text-lg font-medium text-gray-800">No currencies found</h3>
          <p className="text-gray-600 text-sm mt-1">
            {searchQuery ? "Try adjusting your search query" : "Get started by adding a new currency"}
          </p>
        </div>
      ) : (
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                  ...
                  <div className="col-span-7">
                    <p className="text-sm text-gray-600 line-clamp-1 md:line-clamp-2">
                      {currency.description || <span className="text-gray-400 italic">No description provided</span>}
                    </p>
                  </div>
            ...
            <FormProvider {...methods}>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-gray-50">
                  ...
                  >
                    {isSubmitting ? <Loading size="sm" color="white" /> : "Save Currency"}
                  </button>
                </div>
              </form>
            </FormProvider>
