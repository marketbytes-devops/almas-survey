...
const Trucks = () => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <PageHeader title="Trucks" subtitle="Manage fleet and truck types" />
            ...
            <div className="px-6 space-y-6 pb-12">
                ...
                >
                    ...
                    <span className="text-sm tracking-wide">Add New Truck</span>
                </button>
                ...
                {filteredTrucks.length === 0 ? (
                    <div className="bg-white rounded-3xl p-16 text-center border border-dashed border-gray-200">
                        ...
                        <h3 className="text-lg font-medium text-gray-800">No trucks found</h3>
                        <p className="text-gray-600 text-sm mt-1">
                            {searchTerm ? "Try adjusting your search query" : "Get started by adding a new truck"}
                        </p>
                    </div>
                ) : (
