/* src/pages/AdditionalSettings/Labours.jsx */
...
const Labours = () => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <PageHeader title="Labours" subtitle="Manage labour types and details" />
            ...
            <div className="space-y-6">
                ...
                {hasPermission("labours", "add") && (
                    <button
                        onClick={() => setIsAddModalOpen(true)}
                        className="w-full btn-primary"
                    >
                        <FiPlus className="w-5 h-5" />
                        <span className="text-sm tracking-wide">Add New Labour</span>
                    </button>
                )}
                ...
                {filteredLabours.length === 0 ? (
                    <div className="bg-white rounded-3xl p-16 text-center border border-dashed border-gray-200">
                        ...
                        <h3 className="text-lg font-medium text-gray-800">No labours found</h3>
                        <p className="text-gray-600 text-sm mt-1">
                            {searchTerm ? "Try adjusting your search query" : "Get started by adding a new labour type"}
                        </p>
                    </div>
                ) : (
