                ...
                {dummyMembers.map((m, i) => (
                  <tr key={m.id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-4 py-4 text-center">
                      <label
                        htmlFor={`sig-${m.id}`}
                        className="cursor-pointer inline-flex items-center bg-green-600 hover:bg-green-700 text-white font-medium px-4 py-2 rounded-lg text-sm transition shadow-sm"
                      >
